...
> 작성일: 2026-05-13
> 작성자: ㈜다온플레이스
> 관련 문서: SRS-001 / IA-001 (v1.3) / DB-001 / IF-001 / 화면설계서 90개
...
| SFR-006 | 전담조직 관리 | ORG01-V, ORG02-L, ORG02-D, ORG03-V | ORG02-M, ORG02-M2, ORG03-M ~~ORG04-S 폐기~~ → SYS01-S |
...
|---------|--------|-------------|------|
| ★★★ | 6 + 공통 외부 연동 | 39개 (40 - 2 폐기 + 1 신규 SYS01-S) | ✅ |
| ★★ | 8 | 31개 | ✅ |
| ★ | 6 | 20개 | ✅ |
...
> 📌 본 RTM v1.2는 외부 시스템 연동 통합(결정사항 #24) 반영 완료. 전체 SFR 21개 / 90개 화면 / 결정사항 24개 100% 매핑. 외부 인터페이스 스펙 수령 후 IF-001 §1~§6 페이로드 일관성 + SYS01-S 신규 테이블(integration_configs, integration_mapping_rules) DB-001 추가 필요.
